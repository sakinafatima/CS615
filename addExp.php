          ...
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" name="form1" method="post" action="addExp.php" autocomplete="on">
                ...
                <select name='tasks[]' id="tasks1" multiple data-placeholder="Select tasks for this experiment" required>
                  <?php
                  require("sqlconnection.php");
  ...
  <script>
    $(document).ready(function() {
      ...
      var span = $("<span />")
        .text(placeholder)
        .appendTo(active);
//function to hide each selection
      ...
      select.wrap(div);
//on click and multiple select function
...
//on click addition or removal of div with animation
...
//select option hiding function
      ...
      select.wrap(div);
//select multiple hiding and adding function
...
<?php
//takes experiment details to on submit button click
if(isset($_POST['add'])){
$expID=$_POST['expID'];
$name=$_POST['name'];
$subject=$_POST['subject'];
//validating if experiment name exists or not
...
{
shuffle($_POST['tasks']);//using this function to reorder the tasks for each user in a same experiment 
$task1=implode(',',$_POST['tasks']);//using implode to save each task as a seperate record in the database to make fetching and editing of records easier in future
