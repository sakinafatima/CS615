...
<body>
  ...
  <div class="main-content">
    ...
    <!-- Style JS -->
    <script src="./assets/js/style.js?v=1.0.0"></script>
    <script>
...
{
	if($passC==$passN)//validating that user has confirmed the password update
	{
		//uodating user's profile password using mysql update command
