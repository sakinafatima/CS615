...
<?php
//taking user details on the click of submit button
if(isset($_POST['add'])){
$name=$_POST['name'];
$email=$_POST['email'];
$pass=$_POST['password'];
...
//validating that similar email does not exists already
...
{
//saving user details in the users table in database
